...
public class AdjustmentRepository implements PanacheRepository<Adjustment> {
    ...
    /**
     * Get ApartmentSpecificAdjustment records with optional filer and pagination
     */
    public List<Adjustment> getApartmentAdjustmentsByFilter(
                                        BigDecimal adjustmentAmount,
                                        Adjustment.AdjustmentType adjustmentType,
                                        LocalDate effectiveDate,
                                        LocalDate expiryDate,
    ...
    public Long countApartmentAdjustmentsByFilter(
            BigDecimal adjustmentAmount,
            Adjustment.AdjustmentType adjustmentType,
            LocalDate effectiveDate,
            LocalDate expiryDate) {
